...
public interface LicenseeService {
     ...
     */
    Licensee create(Context context, String productNumber, Licensee newLicensee) throws BaseCheckedException;
     ...
     *             corresponding service response messages.
     */
    Licensee get(Context context, String number) throws BaseCheckedException;
     ...
     *             corresponding service response messages.
     */
    Page<Licensee> list(Context context, String filter) throws BaseCheckedException;
     ...
     *             corresponding service response messages.
     */
    Licensee update(Context context, String number, Licensee updateLicensee) throws BaseCheckedException;
     ...
     *             corresponding service response messages.
     */
    ValidationResult validate(Context context, String number, String productNumber) throws BaseCheckedException;
